      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            {[
              { icon: MapPin, title: 'Alamat', value: 'Jl. Pelita 1 No. 26\nMedan Perjuangan, Sumatera Utara', color: 'bg-primary-50 text-primary-500' },
              { icon: Phone, title: 'Telepon / WhatsApp', value: '+62 853-7701-8574', color: 'bg-earth-50 text-earth-500' },
            ...
            <div className="mt-6 bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100">
              <div className="bg-gray-100 h-64 flex items-center justify-center">
                <div className="text-center text-gray-400">
                  ...
                  <p className="text-xs">Jl. Pelita 1 No. 26, Medan Perjuangan</p>
                </div>
              </div>
            </div>
          </div>
